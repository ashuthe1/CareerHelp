...
const EditJob = () => {
  ...
  const getJob = async () => {
    try {
      const response = await fetch(
        `https://careerhelper.onrender.com/job/${id}`
      );
  ...
  const editJob = async (e) => {
    ...
    try {
      ...
      await fetch(`https://careerhelper.onrender.com/updateJob/${id}`, {
        method: "PATCH",
  ...
  const handleDelete = async () => {
    try {
      await fetch(`https://careerhelper.onrender.com/deleteJob/${id}`, {
        method: "DELETE",
      });
